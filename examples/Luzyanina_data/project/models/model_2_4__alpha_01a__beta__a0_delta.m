...
M.time = t;
M.age = a;
M.name = 'model_2_4__alpha_01a__beta__a0_delta';
...
M.alpha{3} = (10^log10_k_alpha_1) * (a.^(10^log10_n_alpha))./((10^log10_K_alpha)^(10^log10_n_alpha) + a.^(10^log10_n_alpha));
M.alpha{4} = (10^log10_k_alpha_1) * (a.^(10^log10_n_alpha))./((10^log10_K_alpha)^(10^log10_n_alpha) + a.^(10^log10_n_alpha));
M.alpha{5} = (10^log10_k_alpha_1) * (a.^(10^log10_n_alpha))./((10^log10_K_alpha)^(10^log10_n_alpha) + a.^(10^log10_n_alpha));
M.alpha{6} = (10^log10_k_alpha_1) * (a.^(10^log10_n_alpha))./((10^log10_K_alpha)^(10^log10_n_alpha) + a.^(10^log10_n_alpha));
M.alpha{7} = (10^log10_k_alpha_1) * (a.^(10^log10_n_alpha))./((10^log10_K_alpha)^(10^log10_n_alpha) + a.^(10^log10_n_alpha));
M.alpha{8} = 0;
% Death rates
